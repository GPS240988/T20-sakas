---
name: gsd-spec-phase
description: "Esclarece O QUE uma fase entrega com pontuação de ambiguidade; produz um SPEC.md antes do discuss-phase."
---
...
<process>
Execute the spec-phase workflow from @~/.gemini/antigravity/get-shit-done/workflows/spec-phase.md end-to-end.
